export class ApiLinks {
  ...
  public static bookingHistoryBaseUrl = 'http://10.177.1.225:8083/booking/superPnr';


  public static searchBase = 'http://10.177.1.225:8083/flight/search';
  public static flightDetailsBase = 'http://10.177.1.225:8083/flight/detail';
  public static flightCreateBooking = 'http://10.177.1.225:8083/booking/createBooking';
  public static makePaymentUrl = 'http://10.177.1.225:8083/payment/card/makePayment';
